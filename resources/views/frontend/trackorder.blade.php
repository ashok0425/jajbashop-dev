...
<div class="progress-bar bg-danger" role="progressbar" style="width: 15%" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100"></div>
 ...
 @endif
  ...
  <ul class="list-group col-lg-12">
  	...
  	<li class="list-group-item"> <b>Tracking Code:</b> {{ $track->tracking_code  }}</li>

  	<li class="list-group-item"> <b>Shipping:</b>Rs. {{ $track->shipping_charge  }}</li>
  	<li class="list-group-item"> <b>Subtotal:</b>Rs. {{ $track->total  }}</li>
  	<li class="list-group-item"> <b>Order On:</b> {{ carbon\carbon::parse($track->created_at)->format('d M Y') }}</li>
